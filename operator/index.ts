...
const signAndRespondToTask = async (taskIndex: number, taskCreatedBlock: number, taskName: string) => {
    ...
    const tx = await poolVaultManager.respondToTask(
...
const monitorNewTasks = async () => {
    ...
    //await poolVaultManager.createNewTask("EigenWorld");

    poolVaultManager.on("NewTaskCreated", async (taskIndex: number, task: any) => {
